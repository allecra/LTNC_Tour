...
public class TransactionController {
    ...
    // API lấy danh sách booking với mã giao dịch theo user ID
    ...
    public ResponseEntity<ResponseDTO> getBookingWithTransactionByUserId(@PathVariable Long userId) {
        ...
        return ResponseEntity.ok(new ResponseDTO("Lấy danh sách booking với mã giao dịch thành công", bookings));
    }

    // API lấy danh sách booking active với mã giao dịch theo user ID
    ...
    public ResponseEntity<ResponseDTO> getActiveBookingWithTransactionByUserId(@PathVariable Long userId) {
        ...
        return ResponseEntity.ok(new ResponseDTO("Lấy danh sách booking active với mã giao dịch thành công", bookings));
    }

    // API lấy booking với mã giao dịch theo ID
    ...
    public ResponseEntity<ResponseDTO> getBookingWithTransactionById(@PathVariable Long id) {
        ...
        if (booking != null) {
            return ResponseEntity.ok(new ResponseDTO("Lấy thông tin booking với mã giao dịch thành công", booking));
        }
        return ResponseEntity.notFound().build();
    }

    // API lấy tất cả booking với mã giao dịch (có filter)
    @GetMapping("/bookings")
