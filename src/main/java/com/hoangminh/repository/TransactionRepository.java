...
public interface TransactionRepository extends JpaRepository<Booking, Long> {
    ...
    // Query để lấy booking với mã giao dịch cho user
    @Query(value = "SELECT new com.hoangminh.dto.BookingDTOWithTransaction(b.id, CONCAT('GD', LPAD(CAST(b.id AS string), 5, '0')), b.user.id, b.tourStart.tour.id, b.tourStart.tour.ten_tour, b.so_luong_nguoi, b.tourStart.ngay_khoi_hanh, b.tong_tien, b.trang_thai, b.payment_method, b.ghi_chu, b.booking_at) "
    ...
    // Query để lấy booking với mã giao dịch cho user (active bookings)
    @Query(value = "SELECT new com.hoangminh.dto.BookingDTOWithTransaction(b.id, CONCAT('GD', LPAD(CAST(b.id AS string), 5, '0')), b.user.id, b.tourStart.tour.id, b.tourStart.tour.ten_tour, b.so_luong_nguoi, b.tourStart.ngay_khoi_hanh, b.tong_tien, b.trang_thai, b.payment_method, b.ghi_chu, b.booking_at) "
